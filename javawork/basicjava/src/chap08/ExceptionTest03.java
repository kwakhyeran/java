...
//1.사용자가 제대로된 값을 입력 : 예외가 발생x ->catch블럭을 실행되지 않는다.
//2.사용자가 나눌숫자에 0을 입력
...
//	-다양한 Exception의 처리를 위해서 catch블럭을 여러개 정의하고 사용할 수 있다.
//	-상위타입에 속하는 Exception은 가장 나중에 정의해야한다.
public class ExceptionTest03 {
	public static void main(String[] args) {
		...
		try {                   
		...
		} catch (InputMismatchException e) {				//예외처리할때 예외순서 주의!
			...
			System.out.println("에외메시지 : " + e.getMessage());
			// e.printStackTrace();
		}
